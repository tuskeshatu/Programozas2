...
bool Player::equipWeapon(Weapon* weapon)
{
	...
	// NEM, HANEM EGY ARRA MUTATÓ POINTERT, AMI KÖNNYEN
	// VEZETHET STACKEN LEVŐ OBJECT DELETELÉSÉRE
	// MEG AMÚGY IS INKÁBB:
...
bool Player::dropSelected()
{
	...
	//weapons[selectedWeaponIndex]->~Weapon();
...
bool Player::attack(Player& enemy) const
{
	...
	//    a) már nem élünk
	//    b) nincs fegyverünk
	if (isAlive() == false || getSelectedWeapon() == nullptr)
	 	return false;
